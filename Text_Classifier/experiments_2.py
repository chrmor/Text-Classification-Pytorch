...
experiments_to_run = []
fixed = "python main.py --cuda True --load_model False --save_model False --do_training True --use_gputil False --field full-text"
